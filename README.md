...
- **화면 타일 관측 + 오프라인 재렌더** — [`tools/tiletool/`](tools/tiletool/). 에뮬로 화면을 한 번 기록해 두면, 이후 임의의 판을 **에뮬 없이 0.2초 만에** 픽셀 비교합니다. v0.99b 기록 하나로 v0.63·v0.95를 재렌더하면 「괴제 강림」 파손이 그대로 재현됩니다
