...
| 파일 | 내용 |
|---|---|
| [`SS2_Korean_v0.99b.ips`](SS2_Korean_v0.99b.ips) | 기본판 |
| [`SS2_Korean_v0.99b_allcards.ips`](SS2_Korean_v0.99b_allcards.ips) | 올카드판 — 카드 121장 전부 개방된 세이브 포함 |
...
- **화면 타일 관측 + 오프라인 재렌더** — [`tools/tiletool/`](tools/tiletool/). 16화면을 기록해 두고 임의의 판을 **에뮬 없이 0.5초 만에** 픽셀 비교합니다. v0.99b 기록으로 v0.63·v0.95를 재렌더하면 「괴제 강림」 파손이 그대로 재현되고, v0.98b→v0.99b 비교는 v0.99b에서 손댄 카드 라벨 화면 4개만 정확히 집어냅니다
