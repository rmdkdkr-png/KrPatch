...
두 단계를 거친 결과가 `md5 1241357f5400eff8385e576376753003`, 원본 대비 IPS 1,056바이트.
...
**획이 굵어야 한다.** Galmuri14 는 획이 1px 이라 1px 검은 외곽선에 속이 먹혀 안 읽힌다.
Galmuri11-Bold 를 ppem 16 으로 그려야 원판처럼 굵게 나온다.

**색 인덱스는 1=검은 외곽선, 2=노란 채움**이다 (3은 파란 그림자, 안 쓴다).
